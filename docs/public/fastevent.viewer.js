                ...
                <div class="log-content">
                    <div class="log-header">
                        ...
                        ${this.showListeners?"":c`<span
                                  ...
                                  title="${d("eventViewer.totalListeners",this.log.listeners.length)}"
                                  @click="${()=>this._toggleListeners()}">${$(`ƒ(${this.log.listeners.length})`,"purple",void 0,void 0,this.dark)}</span>`}
