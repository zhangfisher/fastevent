...
describe('scope', () => {
    ...
    describe('scope emitAsync', () => {
        ...
        test('多层作用域异步事件传播', async () => {
            ...
            expect(events).toEqual(['root:a/b/c/x', 'scope1:b/c/x', 'scope2:c/x', 'scope3:x']);
            expect(results).toEqual(['root', 'scope1', 'scope2', 'scope3']);
        });
    });
    ...
    test('nested scope', async () => {
        ...
        expect(anyEvents).toEqual(['root', 'a/b/c/c', 'c', 'a/b/c/d/d', 'd/d', 'd', 'a/b/c/e/e', 'e/e', 'e', 'a/b/c/f/f', 'f/f', 'f']);
    });
    test('nested scope2', async () => {
        ...
        expect(anyEvents).toEqual(['root', 'a/b/c/c', 'c', 'a/b/c/d/d', 'd/d', 'd', 'a/b/c/d/e/e', 'd/e/e', 'e/e', 'e', 'a/b/c/d/e/f/f', 'd/e/f/f', 'e/f/f', 'f/f', 'f']);
    });
    ...
    test('创建后绑定scope', async () => {
        ...
        scope.emit('x', 1);
        expect(events).toEqual(['a/b/c/x', 'x']);
    });
